...
from src.model.blocks.utils import init_weights, get_padding
    ...
    def forward(self, x, speaker):
        ...
        for i in range(self.num_upsamples):
            ...
            for j in range(self.num_kernels):
                if xs is None:
                    xs = self.resblocks[i*self.num_kernels+j](x, speaker)
                else:
                    xs += self.resblocks[i*self.num_kernels+j](x, speaker)
...
class Descriminator(nn.Module):
    ...
    def forward(self, generated, real):
        #print(generated.shape, real.shape, 'shape')

        p_real_outs, p_gen_outs, p_real_feat, p_gen_feat = self.mpd(real, generated)
        s_real_outs, s_gen_outs,s_real_feat, s_gen_feat = self.msd(real, generated)
        return {
